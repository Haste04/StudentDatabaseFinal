...
public class StudentAdapter extends RecyclerView.Adapter<StudentAdapter.StudentHolder> {
    ...
    public static final int EDIT_STUDENT_REQUEST = 1;
    ...
    public void refreshData(List<Student> newStudents) {
        studentList.clear();
    ...
    private boolean handleMenuClick(MenuItem item, int position) {
        ...
        if (item.getItemId() == R.id.edit) {
            ...
            // ✅ Start AddMenu
            ((Activity) context).startActivityForResult(intent, EDIT_STUDENT_REQUEST);
            return true;
